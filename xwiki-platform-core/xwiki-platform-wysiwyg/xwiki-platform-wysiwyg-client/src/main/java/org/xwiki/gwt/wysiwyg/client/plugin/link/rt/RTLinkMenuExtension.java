...
/**
 * Provides user interface for manipulating RT links through the WYSIWYG top-level menu.
 *
 * @version $Id$
 */
public class RTLinkMenuExtension extends MenuItemUIExtensionAdaptor
{
    /**
     ...
     */
    private final RTLinkPlugin plugin;
     ...
     */
    public RTLinkMenuExtension(final RTLinkPlugin plugin)
    {
        super("menu");
