 ...
 * @version $Id$
 */
public class RTLinkPlugin extends BaseRealTimePlugin implements WizardListener
{
    /**
     ...
     */
    private RTLinkMenuExtension menuExtension;
    ...
    /**
     * The object used to serialize a {@link org.xwiki.gwt.wysiwyg.client.plugin.link.LinkConfig} instance to JSON.
     */
     ...
     */
    public RTLinkPlugin(WikiServiceAsync wikiService)
    {
    ...
    public void init(RichTextArea textArea, Config config)
    {
        ...
        menuExtension = new RTLinkMenuExtension(this);
     ...
     * {@inheritDoc}
     *
     * @see org.xwiki.gwt.wysiwyg.client.plugin.internal.AbstractPlugin#destroy()
     */
    public void destroy()
    {
...
//            getTextArea().getDocument().getSelection().getRangeAt(0), linkConfig.getUrl()));
    ...
    /**
     * {@inheritDoc} <p> Handles wizard finish by creating the link HTML block from the {@link
     * org.xwiki.gwt.wysiwyg.client.plugin.link.LinkConfig} setup through the wizard and executing the {@link
     * org.xwiki.gwt.user.client.ui.rta.cmd.Command#CREATE_LINK} with it.
     *
     * @see org.xwiki.gwt.user.client.ui.wizard.WizardListener#onFinish(org.xwiki.gwt.user.client.ui.wizard.Wizard,
     *      Object)
     */
    public void onFinish(Wizard sender, Object result)
    {
        ...
        LinkConfig linkConfig = (LinkConfig) result;

        clientJupiter.generate(treeOperationFactory.createLink(clientJupiter.getSiteId(),
            getTextArea().getDocument().getSelection().getRangeAt(0), linkConfig.getUrl()));
        Console.getInstance().log("RTP: onFinish ");
    }

    /**
     * {@inheritDoc}
     *
     * @see org.xwiki.gwt.user.client.ui.wizard.WizardListener#onCancel(org.xwiki.gwt.user.client.ui.wizard.Wizard)
     */
